...
export default async function ClassifiedPage() {
  const page = await sanityFetch<SanityStaticPage>(STATIC_PAGE_BY_SLUG_QUERY, { slug: 'activities-classified' })
  if (!page) return <main><h1>Classified</h1><p>Coming soon.</p></main>
