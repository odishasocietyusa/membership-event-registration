...
export default async function HigherEducationPage() {
  const page = await sanityFetch<SanityStaticPage>(STATIC_PAGE_BY_SLUG_QUERY, { slug: 'activities-higher-education' })
  if (!page) return <main><h1>OSA Higher Education</h1><p>Coming soon.</p></main>
