...
export default async function AdministrationPage() {
  const page = await sanityFetch<SanityStaticPage>(STATIC_PAGE_BY_SLUG_QUERY, { slug: 'about-administration' })
  if (!page) return <main><h1>OSA Administration</h1><p>Coming soon.</p></main>
