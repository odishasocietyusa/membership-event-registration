...
export default async function VisionMissionPage() {
  const page = await sanityFetch<SanityStaticPage>(STATIC_PAGE_BY_SLUG_QUERY, { slug: 'about-vision-mission' })
  if (!page) return <main><h1>Vision &amp; Mission</h1><p>Coming soon.</p></main>
