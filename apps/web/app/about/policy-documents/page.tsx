...
export default async function PolicyDocumentsPage() {
  const page = await sanityFetch<SanityStaticPage>(STATIC_PAGE_BY_SLUG_QUERY, { slug: 'about-policy-documents' })
  if (!page) return <main><h1>Policy Documents</h1><p>Coming soon.</p></main>
